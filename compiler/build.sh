...
wget --no-check-certificate https://repo1.maven.org/maven2/com/google/errorprone/error_prone_core/2.8.0/error_prone_core-2.8.0-with-dependencies.jar -P base/plugins/
wget --no-check-certificate https://repo1.maven.org/maven2/io/github/eisop/dataflow-errorprone/3.42.0-eisop4/dataflow-errorprone-3.42.0-eisop4.jar -P base/plugins/
